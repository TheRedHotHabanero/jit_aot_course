...
public:
    ...
    STLCompliantArenaAllocator(const STLCompliantArenaAllocator&) noexcept = default;
    STLCompliantArenaAllocator& operator=(const STLCompliantArenaAllocator&) noexcept = default;
    STLCompliantArenaAllocator(STLCompliantArenaAllocator&&) noexcept = default;
    STLCompliantArenaAllocator& operator=(STLCompliantArenaAllocator&&) noexcept = default;
